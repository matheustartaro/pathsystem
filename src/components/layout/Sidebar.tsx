...
export function Sidebar() {
  ...
  const phaseMap = {
    'minimal': 1,
    'icons': 1, // Agora icons também mapeia para 1
    'expanded': 3,
    'dual-pane': 4
  };
      ...
      >
        ...
        <div className={cn(
          ...
          <div className="mt-auto shrink-0 flex flex-col py-4 gap-3 items-center">
            ...
            <button 
              className="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-accent text-muted-foreground hover:text-foreground transition-colors relative" 
              title="Notificações"
            >
              <Bell size={20} />
            ...
            >
              ...
              <div className={cn(
                ...
                <div className="px-3 mb-2">
                  <button
                    onClick={toggleSidebar}
                    className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-accent text-foreground text-sm font-medium"
                  >
                ...
                <div className="flex-1 overflow-y-auto px-3 space-y-0.5">
                  {modules.map(mod => (
                    <button
                      ...
                      className={cn(
                        'w-full text-left px-3 py-2.5 rounded-lg flex items-center justify-between transition-all text-sm',
                        activeGroup === mod.id 
                ...
                <div className="px-3 pt-3 mt-auto border-t border-border/50 space-y-1">
                  <div className="flex items-center justify-between px-3 py-2">
                    ...
                    <button 
                      ...
                      className={cn(
                        ...
                        locked ? 'bg-foreground' : 'bg-muted'
                      )}
                      title={locked ? "Destravar menu" : "Fixar menu aberto"}
                    >
                      <div className={cn(
                        'absolute top-0.5 w-4 h-4 bg-card rounded-full transition-all shadow-sm',
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground hover:bg-accent px-3 py-2 rounded-lg transition-colors w-full text-left"
                  >
      ...
      <AnimatePresence>
        {phase >= 3 && !locked && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-foreground/5 backdrop-blur-[1px] z-40 lg:block hidden"
